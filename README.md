...
Currently, the files that employ the API conflict with some of the additions I made in the typeclasses. So, the typeclasses (e.g. rooms.py) have been reverted back to evennia defaults. the modified versions are stored as .MYVERSION files.
